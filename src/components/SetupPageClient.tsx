    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="mx-auto flex min-h-screen max-w-md items-center px-4">
        <div className="w-full rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6">
          ...
          <p className="mt-1 text-sm text-zinc-400">Create the first admin user for this Patron Hub instance.</p>

          <form onSubmit={onSubmit} className="mt-5 space-y-3">
            <label className="block">
              <div className="mb-1 text-xs font-medium uppercase tracking-wider text-zinc-500">Admin email</div>
              <input
                value={email}
            ...
            <label className="block">
              <div className="mb-1 text-xs font-medium uppercase tracking-wider text-zinc-500">Admin password</div>
              <input
                type="password"
                value={password}
              ...
              />
              <div className="mt-1 text-xs text-zinc-600">Use a strong password. This app will be on your network.</div>
            </label>
